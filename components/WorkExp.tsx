...
const WorkExp = () => {
  ...
  return (
    <div className="lg:px-24 md:px-8 px-6 mt-20 flex flex-col gap-y-6" id="exp">
      ...
      <ol className="relative flex flex-col pl-1 bg-gradient-to-r from-rose-500 via-fuchsia-600 to-indigo-700">
        <div>
          ...
          <li className="mb-10 ms-7">
            ...
            <div className="text-base font-normal text-gray-200">
              <ul className="list-disc">
                ...
                <li>
                  Proficiently integrated 20 diverse REST APIs for real-time
                  data, enhancing application functionality.
                </li>
                <li>
            ...
            <div className="text-base font-normal text-gray-200">
              <ul className="list-disc">
                ...
                <li>
                  ...
                  remarkable 18% improvement, ultimately resulting in a
                  noteworthy 0.39% increase in revenue.
                </li>
                <li>
                ...
                <li>
                  ...
                  style guide and component library, streamlining development
                  and ensuring a consistent user interface.
                </li>
              </ul>
            </div>
          </li>
