...
const ContactMe = () => {
  ...
  return (
    <div
      ...
      id="contact"
    >
      <h5 className="text-4xl md:text-5xl text-center lg:text-start text-white">Contact Me</h5>
        ...
        <div className="flex flex-col gap-y-5 text-center lg:text-start">
          ...
          <div className="text-2xl flex flex-col gap-y-5">
            ...
            <p>
              ...
              developer, I'm here to collaborate with you and turn your vision
              into reality. Whether you need a sleek website, a powerful web
              application, or anything in between, I've got you covered.
            </p>
            <p>
              ...
              Let's connect and embark on a journey to create something truly
              remarkable.
            </p>
            <p>
